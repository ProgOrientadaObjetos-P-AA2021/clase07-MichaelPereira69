    ...
    public static void main(String[] args) {
     ...
     //   System.out.println(profesores2.get(1).obtenerTipo());
       ...
       */ 
        ...
        Profesor prof3 = new Profesor("Maicol P", "Gerente");
        Profesor prof4 = new Profesor("Meli G", "Profesora");
        Profesor prof5 = new Profesor("Michael", "Trabajador");
        Profesor prof6 = new Profesor("Maria P", "Estudiante");


        profesores2.add(prof3);
        profesores2.add(prof4);
        profesores2.add(prof5);
        profesores2.add(prof6);
